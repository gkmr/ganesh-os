...
```jsx
<ChangeLogLine time="06:04" agent="morning-sweep" field="due_date(M51)" note="# read-after-write ✓" />
<ChangeLogLine time="13:40" agent="reply-processor" field="lifecycle(J02)" />
